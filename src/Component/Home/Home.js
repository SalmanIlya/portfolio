...
<p className='heading1  text w-50 p-5 ps-5 pt-5'> 
  WORLD NEEDS SPECIAL GIFT THAT ONLY YOU HAVE!
</p>
</div>
<div className=' mt-5'>
    <div className='container-1 m-3 p-5 shadow-lg d-flex flex-row justify-content-between'>
      <div><h3 className='text-cc m-2 com-name d-flex'><span>FEATURED</span><span>  IN</span></h3></div>
      <div><h3 className='m-2 com-name d-felx'><span>FFSteel(Pvt)</span><span>Limited</span> </h3></div>
      <div><h3 className='m-2 com-name d-flex'><span>Al-Hafiz</span><span>Crystoplast(Pvt)Limited</span> </h3></div>
      <div><h3 className='m-2 com-name d-flex'><span> Ays</span><span>Electronics</span></h3></div>
    </div>
    </div>
    <div id="about" className='mt-5 shadow-lg p-3 mb-5 bg-white rounded container-1 m-5'>
        <div className=' mt-5 '>
